...
//     let hyper_service = hyper::service::service_fn(move |_request: Request<Body>| async {
...
// use hyper::{service::service_fn, server::conn::Http, Request, Response};
...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let tls_config = Arc::new(load_cfg::load_tls_config()?);
...
async fn handle_connection(
    ...
    // http1::Builder::serve_connection(&self, io, service)
